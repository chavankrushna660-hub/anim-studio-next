    ...
    return (
      <div key={obj.id} className="flex flex-col">
        <div
          ...
          className={`flex items-center justify-between py-1.5 px-2 rounded-xl group/item transition-colors select-none ${
            isInteractable ? 'cursor-pointer' : 'cursor-not-allowed opacity-50'
          } ${
            isSelected 
