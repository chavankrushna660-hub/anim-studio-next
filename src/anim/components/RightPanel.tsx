...
export default function RightPanel({
  ...
  const isLassoActive = (!!lassoPoints && lassoPoints.length >= 3) || !!targetObject?.lassoDeformState?.active || !!targetObject?.vstState?.active || (activeTool === 'VST' && !!targetObject?.vstState?.active);
                            ...
                            <div className="flex items-center justify-between gap-2">
                              <div className="flex items-center gap-2 overflow-hidden flex-1">
                                <button
                                  ...
                                  title={isCurrentlySelected ? 'Click to unselect' : 'Click to select this part'}
                                >
                                  {part.name}
                                </button>
                              </div>
                              ...
                              <div className="flex items-center gap-1.5">
                                ...
                                >
                                  {isCurrentlySelected ? 'Unselect' : 'Select'}
                                </button>
